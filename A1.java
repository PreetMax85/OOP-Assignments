...
class operations
{
    ...
    {
        double diffReal = c1.real - c2.real ;
        double diffImg = c1.img - c2.img ;
        complex ans = new complex() ;
    ...
    {
        double prodReal = (c1.real*c2.real) - (c1.img*c2.img) ;
        double prodImg = (c1.real*c2.img) + (c1.img*c2.real) ;
        complex ans = new complex() ;
    ...
    {
        float divReal= (float) (((c1.real * c2.real) + (c1.img * c2.img)) /((c2.real*c2.real)+(c2.img*c2.img))) ;
        float divImg= (float) (((c1.img * c2.real) - (c1.real * c2.img)) /((c2.real*c2.real)+(c2.img*c2.img))) ;
        complex ans=new complex() ;
        ans.setValue(divReal,divImg) ;
        return ans ;
    }
}
 class Man {
    public static void main(String[] args) {
        ...
        while(true) // Until exited
        {
            ...
            else
            {
                ...
                System.out.println((float)ansDiv.real + " + " + (float)ansDiv.img + "i" );
            }
            System.out.println() ;
        }
    }
